...
export const services: Record<string, ServiceData> = {
  "gestion-airbnb": {
    id: "01",
    title: "Annonce qui performe",
    description: "Photos pro, texte accrocheur, analyse concurrences et étude du prix. Votre bien remplit le calendrier.",
    benefit: "→ Plus de réservations",
  ...
  "selection-voyageurs": {
    id: "02",
    title: "Que les bons voyageurs",
    description: "On gère les échanges et on sélectionne chaque profil. Vous n'ouvrez votre porte qu'aux bons locataires.",
    benefit: "→ Zéro mauvaise surprise",
  ...
  "check-in-out": {
    id: "03",
    title: "Un accueil qui marque",
    description: "Notre équipe locale accueille vos voyageurs, remet les clés et vérifie le bien à chaque départ.",
    benefit: "→ Des avis qui font la différence",
  ...
  "menage-linge": {
    id: "04",
    title: "Propre comme un hôtel",
    description: "Ménage complet et linge frais après chaque séjour. Vos voyageurs arrivent dans un bien impeccable.",
    benefit: "→ 5 étoiles à chaque fois",
  ...
  "assurances-cautions": {
    id: "05",
    title: "Sécurité & Accompagnement Litiges",
    description: "En cas de problème avec un voyageur, vous n'êtes pas seul. On vous accompagne dans chaque démarche.",
    benefit: "→ Votre bien protégé intelligemment",
  ...
  "maintenance-assistance": {
    id: "06",
    title: "On gère les imprévus",
    description: "Un robinet qui fuit, un verrou bloqué ? Notre équipe intervient rapidement pour que rien ne freine votre location.",
    benefit: "→ Réglé avant que ça coince",
