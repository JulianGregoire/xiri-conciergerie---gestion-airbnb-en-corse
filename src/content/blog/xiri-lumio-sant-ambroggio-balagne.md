...
heroImage: ../../assets/images/blog/lumio/plage-sant-ambroggio-hero.png
...
sections:
  ...
  - title: "Notre bien : le studio Cassetta 92 à Lumio"
    paragraphs:
      ...
      - |
        Photos pro, annonces optimisées (Airbnb, Booking, direct), tarification dynamique calée sur le calendrier balanin (Calvi On The Rocks, vacances scolaires européennes) : on applique la même méthode qu'à tous nos biens. C'est aussi notre vitrine.
    images:
      - ../../assets/images/blog/lumio/studio-lumio-1.jpg
      - ../../assets/images/blog/lumio/studio-lumio-2.jpg
      - ../../assets/images/blog/lumio/studio-lumio-3.jpg
      - ../../assets/images/blog/lumio/studio-lumio-4.jpg
      - ../../assets/images/blog/lumio/studio-lumio-5.jpg
      - ../../assets/images/blog/lumio/studio-lumio-6.jpg

  - title: "Conciergerie en Balagne : ce qu'on fait concrètement"
    paragraphs:
      - |
        Confier sa location saisonnière à Xiri, ce n'est pas juste déléguer le ménage. C'est gestion complète : annonces multi-plateformes, tarification dynamique, accueil personnalisé, ménage standard hôtelier, linge, interventions techniques, reporting en temps réel.
      - |
        Notre équipe est physiquement en Balagne. Pas un call center : des gens qui connaissent les plombiers du coin, les pressings, les serruriers de garde. Un voyageur arrive à 1h du matin par le ferry de L'Île-Rousse ? Quelqu'un est là.
      - |
        Clientèle internationale à accueillir en plusieurs langues, biens souvent mal valorisés en ligne, contraintes d'insularité — ces particularités, on les vit au quotidien depuis le lancement de Xiri en Corse.
    images:
  ...
  - title: "Propriétaires à Lumio & Sant'Ambrogio : confiez-nous votre bien"
    paragraphs:
      ...
      - |
        On est sur place, on connaît le terrain. Pas une agence anonyme à 800 km — une équipe locale, joignable et redevable. Première consultation gratuite, sans engagement.
    images:
      - ../../assets/images/blog/lumio/plongee-balagne.png
      - ../../assets/images/blog/lumio/studio-lumio-8.jpg
---
