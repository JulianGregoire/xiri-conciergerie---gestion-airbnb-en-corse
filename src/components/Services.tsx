...
const serviceSlides = [
  {
    icon: <img src={iconGestion.src} alt="Gestion d'annonces" className="w-8 h-8 object-contain" />,
  ...
  {
    icon: <img src={iconSelection.src} alt="Sélection des voyageurs" className="w-8 h-8 object-contain" />,
  ...
  {
    icon: <img src={iconCheckin.src} alt="Check-in / Check-out" className="w-8 h-8 object-contain" />,
  ...
  {
    icon: <img src={iconMenage.src} alt="Ménage et blanchisserie" className="w-8 h-8 object-contain" />,
  ...
  {
    icon: <img src={iconAssurance.src} alt="Assurances & cautions" className="w-8 h-8 object-contain" />,
          ...
          {serviceSlides.map((slide, idx) => (
            <div key={idx} className="bg-white border border-xiri-navy/10 p-5 md:p-6 h-full flex flex-col rounded-2xl shadow-sm">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-14 h-14 bg-xiri-bg flex items-center justify-center text-xiri-gold flex-shrink-0 rounded-xl">
                  {slide.icon}
                </div>
